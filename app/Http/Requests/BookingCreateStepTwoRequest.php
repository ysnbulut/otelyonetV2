...
class BookingCreateStepTwoRequest extends FormRequest
{
 /**
 ...
 public function rules(): array
 {
  ...
  return [
   ...
   'open_booking' => 'required_if:type,=,single|in:true,false',
   'number_of_adults' => 'required_if:type,=,single|integer|min:1',
   'number_of_children' => 'required_if:type,=,single|integer|min:0',
 ...
 public function messages(): array
 {
  return [
   ...
   'open_booking.required' => 'Açık Rezervasyon alanı boş bırakılamaz.',
   'open_booking.in' => 'Açık Rezervasyon alanı geçerli bir değer olmalıdır.',
