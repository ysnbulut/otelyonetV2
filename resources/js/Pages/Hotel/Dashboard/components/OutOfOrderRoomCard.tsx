...
interface OutOfOrderRoomCardProps {
	room: IdName
}

function OutOfOrderRoomCard(props: OutOfOrderRoomCardProps) {
	return (
		<div className="intro-y col-span-12 sm:col-span-6 xl:col-span-3">
			<div className="zoom-in box p-2 shadow-lg">
				<div className="flex items-center justify-end rounded-md border-b bg-danger bg-gradient-to-r p-2 shadow-inner dark:bg-danger/60">
			...
			<div
				...
				<span className="text-right text-xs font-semibold">Satışa Kapalı Oda</span>
			</div>
		</div>
	)
}

export default OutOfOrderRoomCard
