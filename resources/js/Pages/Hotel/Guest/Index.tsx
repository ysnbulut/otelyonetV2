...
function Index({ ...props }: PageProps) {
    ...
    const handleKeyDown = (e: any): void => {
        if (e.key === 'Enter') {
            Inertia.get(route('hotel.guests.index'), { search: searchValue }, {
                replace: false,
                preserveState: true,
                only: ['guests'],
            })
    ...
    const handlePerPage = (e: any): void => {
        Inertia.get(route('hotel.guests.index'), { per_page: e.target.value }, {
            replace: true,
            preserveState: true,
        });
        ...
        <div className='grid grid-cols-12 gap-6 mt-5'>
            ...
            <div className='intro-y col-span-12 overflow-auto lg:overflow-visible'>
                <Table className='border-spacing-y-[10px] border-separate sm:mt-2'>
                    ...
                    <Table.Tbody>
                        {props.guests.data.map((guest) => (<Table.Tr key={guest.id} className='intro-y'>
                            <Table.Td
                                ...
                                <Link href={route('hotel.guests.edit', guest.id)}
            ...
            <div className='flex flex-wrap items-center col-span-12 intro-y sm:flex-row sm:flex-nowrap'>
                <Pagination className='w-full sm:w-auto sm:mr-auto'>
                    ...
                    <Pagination.Link href={props.guests.prev_page_url !== null ? props.guests.prev_page_url : '#'}
                                     preserveScroll>
                    ...
                    <Pagination.Link href={'#'}>...</Pagination.Link>
                    <Pagination.Link
                        href={props.guests.next_page_url !== null ? props.guests.next_page_url : '#'}>
