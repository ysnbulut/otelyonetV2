  ...
  return (<div ref={forwardedRef} className='col-span-12 mt-6'>
    {(bookings && bookings.data.length > 0) ? (<>
      ...
      <div className='flex flex-wrap items-center mt-3 intro-y sm:flex-row sm:flex-nowrap'>
        <Button onClick={() => handleLoadMore()} variant='outline-secondary'
                className='block w-full py-3 text-center border border-dotted rounded-md intro-x border-slate-400 dark:border-darkmode-300 text-slate-500 font-light'
