  ...
  fakePhotos() {
    ...
    for (let i = 0; i < 15; i++) {
      photos[photos.length] =
        imageAssets[
          "/resources/images/fakers/profile-" + _.random(1, 15) + ".jpg"
        ].default;
    }
  ...
  fakeImages() {
    ...
    for (let i = 0; i < 15; i++) {
      images[images.length] =
        imageAssets[
          "/resources/images/fakers/preview-" + _.random(1, 15) + ".jpg"
        ].default;
    }
    ...
    const foods = [
      {
        name: "Vanilla Latte",
        image:
          imageAssets["/resources/images/fakers/food-beverage-1.jpg"].default,
      },
      {
        name: "Milkshake",
        image:
          imageAssets["/resources/images/fakers/food-beverage-2.jpg"].default,
      },
      {
        name: "Soft Drink",
        image:
          imageAssets["/resources/images/fakers/food-beverage-3.jpg"].default,
      },
      {
        name: "Root Beer",
        image:
          imageAssets["/resources/images/fakers/food-beverage-4.jpg"].default,
      },
      {
        name: "Pocari",
        image:
          imageAssets["/resources/images/fakers/food-beverage-5.jpg"].default,
      },
      {
        name: "Ultimate Burger",
        image:
          imageAssets["/resources/images/fakers/food-beverage-6.jpg"].default,
      },
      {
        name: "Hotdog",
        image:
          imageAssets["/resources/images/fakers/food-beverage-7.jpg"].default,
      },
      {
        name: "Avocado Burger",
        image:
          imageAssets["/resources/images/fakers/food-beverage-8.jpg"].default,
      },
      {
        name: "Spaghetti Fettucine Aglio with Beef Bacon",
        image:
          imageAssets["/resources/images/fakers/food-beverage-9.jpg"].default,
      },
      {
        name: "Spaghetti Fettucine Aglio with Smoked Salmon",
        image:
          imageAssets["/resources/images/fakers/food-beverage-10.jpg"].default,
      },
      {
        name: "Curry Penne and Cheese",
        image:
          imageAssets["/resources/images/fakers/food-beverage-11.jpg"].default,
      },
      {
        name: "French Fries",
        image:
          imageAssets["/resources/images/fakers/food-beverage-12.jpg"].default,
      },
      {
        name: "Virginia Cheese Fries",
        image:
          imageAssets["/resources/images/fakers/food-beverage-13.jpg"].default,
      },
      {
        name: "Virginia Cheese Wedges",
        image:
          imageAssets["/resources/images/fakers/food-beverage-14.jpg"].default,
      },
      {
        name: "Fried/Grilled Banana",
        image:
          imageAssets["/resources/images/fakers/food-beverage-15.jpg"].default,
      },
      {
        name: "Crispy Mushroom",
        image:
          imageAssets["/resources/images/fakers/food-beverage-16.jpg"].default,
      },
      {
        name: "Fried Calamari",
        image:
          imageAssets["/resources/images/fakers/food-beverage-17.jpg"].default,
      },
      {
        name: "Chicken Wings",
        image:
          imageAssets["/resources/images/fakers/food-beverage-18.jpg"].default,
      },
      {
        name: "Snack Platter",
        image:
          imageAssets["/resources/images/fakers/food-beverage-19.jpg"].default,
      },
    ];
